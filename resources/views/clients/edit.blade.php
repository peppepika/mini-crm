        ...
        <div class="bg-gray-600 overflow-hidden shadow-sm sm:rounded-lg">
            <form method="POST" action="{{ route('clients.update', $client) }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="contact_email" class="block mt-1 w-full" type="email" name="contact_email" :value="old('contact_email', $client->contact_email)" required autocomplete="contact_email" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="company_vat" class="block mt-1 w-full" type="text" name="company_vat" :value="old('company_vat', $client->company_vat)" required autocomplete="company_vat" />
